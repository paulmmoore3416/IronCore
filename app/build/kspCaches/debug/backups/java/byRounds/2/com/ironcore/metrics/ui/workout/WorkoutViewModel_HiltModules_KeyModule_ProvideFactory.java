...
public final class WorkoutViewModel_HiltModules_KeyModule_ProvideFactory implements Factory<Boolean> {
  @Override
  public Boolean get() {
    return provide();
  }
  ...
  public static boolean provide() {
    return WorkoutViewModel_HiltModules.KeyModule.provide();
  }
